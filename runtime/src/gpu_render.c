...
void gr_set_precise_triangle(int e,
                             int32_t x0, int32_t y0, int32_t x1, int32_t y1,
                             int32_t x2, int32_t y2) {
    if (g_b->set_precise_triangle)
        g_b->set_precise_triangle(e, x0, y0, x1, y1, x2, y2);
}
void gr_set_perspective_triangle(int e, float q0, float q1, float q2) {
    if (g_b->set_perspective_triangle)
        g_b->set_perspective_triangle(e, q0, q1, q2);
}
